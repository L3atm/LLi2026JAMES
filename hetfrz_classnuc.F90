...
!++ Longlei Li MAM9 ++
   real(r8) :: Kcoll_dust_a8                               ! collision kernel [cm3 s-1]
   real(r8) :: Kcoll_dust_a9                               ! collision kernel [cm3 s-1]
!-- Longlei Li MAM9 -- 
