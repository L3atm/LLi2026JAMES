    ...
    aero%nbulk  = nbulk
       ...
       if (nmodes > 0) then
          ...
          do l = 1, aero%nspec(aero%mode_coarse_idx)
             ...
             case ('dust-type1')
                aero%coarse7_dust1_idx = l
                aero%coarse8_dust1_idx = l
                aero%coarse9_dust1_idx = l
                aero%coarse10_dust1_idx = l
             case ('dust-type2')
                aero%coarse7_dust2_idx = l
                aero%coarse8_dust2_idx = l
                aero%coarse9_dust2_idx = l
                aero%coarse10_dust2_idx = l
             case ('dust-type3')
                aero%coarse7_dust3_idx = l
                aero%coarse8_dust3_idx = l
                aero%coarse9_dust3_idx = l
                aero%coarse10_dust3_idx = l
             case ('dust-type4')
                aero%coarse7_dust4_idx = l
                aero%coarse8_dust4_idx = l
                aero%coarse9_dust4_idx = l
                aero%coarse10_dust4_idx = l
             case ('dust-type5')
                aero%coarse7_dust5_idx = l
                aero%coarse8_dust5_idx = l
                aero%coarse9_dust5_idx = l
                aero%coarse10_dust5_idx = l
             case ('dust-type6')
                aero%coarse7_dust6_idx = l
                aero%coarse8_dust6_idx = l
                aero%coarse9_dust6_idx = l
                aero%coarse10_dust6_idx = l
             case ('dust-type7')
                aero%coarse7_dust7_idx = l
                aero%coarse8_dust7_idx = l
                aero%coarse9_dust7_idx = l
                aero%coarse10_dust7_idx = l
             case ('dust-type8')
                aero%coarse7_dust8_idx = l
                aero%coarse8_dust8_idx = l
                aero%coarse9_dust8_idx = l
                aero%coarse10_dust8_idx = l
#else
             case ('dust')
...
!#if ( defined DUSTTYPES )
!          if (aero%coarse_dust1_idx == -1 .or. aero%coarse_dust2_idx == -1 .or. aero%coarse_dust3_idx == -1 .or. &
!              aero%coarse_dust4_idx == -1 .or. aero%coarse_dust5_idx == -1 .or. aero%coarse_dust6_idx == -1 .or. &
!              aero%coarse_dust7_idx == -1 .or. aero%coarse_dust8_idx == -1 .or. aero%coarse_nacl_idx == -1) then
!             write(iulog,*) routine//': ERROR required mode-species type not found - indicies:', &
!                aero%coarse_dust1_idx,aero%coarse_dust2_idx,aero%coarse_dust3_idx,aero%coarse_dust4_idx, &
!                aero%coarse_dust5_idx,aero%coarse_dust6_idx,aero%coarse_dust7_idx,aero%coarse_dust8_idx, &
!                aero%coarse_nacl_idx
...
#if ( defined DUSTTYPES )
          if (aero%coarse7_dust1_idx == -1 .or. aero%coarse7_dust2_idx == -1 .or. aero%coarse7_dust3_idx == -1 .or. &
              aero%coarse7_dust4_idx == -1 .or. aero%coarse7_dust5_idx == -1 .or. aero%coarse7_dust6_idx == -1 .or. &
              aero%coarse7_dust7_idx == -1 .or. aero%coarse7_dust8_idx == -1 .or. aero%coarse_nacl_idx == -1) then
             write(iulog,*) routine//': ERROR required mode-species type not found - indicies:', &
                aero%coarse7_dust1_idx,aero%coarse7_dust2_idx,aero%coarse7_dust3_idx,aero%coarse7_dust4_idx, &
                aero%coarse7_dust5_idx,aero%coarse7_dust6_idx,aero%coarse7_dust7_idx,aero%coarse7_dust8_idx, &
                aero%coarse_nacl_idx
             call endrun(routine//': ERROR required mode-species type not found')
          end if
#else
