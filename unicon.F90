         ...
         do iacc = 1, nacc
            ...
            do k = kiss + 1, mkx - 1    ! Here, 'k'  is a layer index.
               ...
               if( k .eq. kiss + 1 ) then    ! Here, 'k' is a layer-index.
                  ...
                  sigma_tr(lptr_dust1_a_amode(modeptr_coarse)) = 0._r8
                  sigma_tr(lptr_dust1_a_amode(modeptr_accum))  = 0._r8
                  sigma_tr(lptr_dust1_a_amode(modeptr_aitken)) = 0._r8

                  sigma_tr(lptr_dust2_a_amode(modeptr_coarse)) = 0._r8
                  sigma_tr(lptr_dust2_a_amode(modeptr_accum))  = 0._r8
                  sigma_tr(lptr_dust2_a_amode(modeptr_aitken)) = 0._r8

                  sigma_tr(lptr_dust3_a_amode(modeptr_coarse)) = 0._r8
                  sigma_tr(lptr_dust3_a_amode(modeptr_accum))  = 0._r8
                  sigma_tr(lptr_dust3_a_amode(modeptr_aitken)) = 0._r8

                  sigma_tr(lptr_dust4_a_amode(modeptr_coarse)) = 0._r8
                  sigma_tr(lptr_dust4_a_amode(modeptr_accum))  = 0._r8
                  sigma_tr(lptr_dust4_a_amode(modeptr_aitken)) = 0._r8

                  sigma_tr(lptr_dust5_a_amode(modeptr_coarse)) = 0._r8
                  sigma_tr(lptr_dust5_a_amode(modeptr_accum))  = 0._r8
                  sigma_tr(lptr_dust5_a_amode(modeptr_aitken)) = 0._r8

                  sigma_tr(lptr_dust6_a_amode(modeptr_coarse)) = 0._r8
                  sigma_tr(lptr_dust6_a_amode(modeptr_accum))  = 0._r8
                  sigma_tr(lptr_dust6_a_amode(modeptr_aitken)) = 0._r8

                  sigma_tr(lptr_dust7_a_amode(modeptr_coarse)) = 0._r8
                  sigma_tr(lptr_dust7_a_amode(modeptr_accum))  = 0._r8
                  sigma_tr(lptr_dust7_a_amode(modeptr_aitken)) = 0._r8

                  sigma_tr(lptr_dust8_a_amode(modeptr_coarse)) = 0._r8
                  sigma_tr(lptr_dust8_a_amode(modeptr_accum))  = 0._r8
                  sigma_tr(lptr_dust8_a_amode(modeptr_aitken)) = 0._r8
#else
