...
!----------------------------------------------------------------------------------
  function sox_cldaero_create_obj(cldfrc, qcw, lwc, cfact, ncol, loffset) result( conc_obj )
    ...
    ! ++ Longlei Li ++
    integer :: id_so4_7a,id_so4_8a,id_so4_9a,id_so4_10a
    integer :: id_nh4_7a,id_nh4_8a
    ! -- Longlei Li --
    integer :: l,n
    integer :: i,k

    logical :: mode7, mode10

    mode7 = ntot_amode == 7
    ! ++ Longlei Li ++
    mode10 = ntot_amode == 10 
    ! -- Longlei Li --
...
!  added by kzm
    elseif (mode10) then
       ...
       id_so4_9a = lptr_so4_cw_amode(10) - loffset
       id_so4_10a = lptr_so4_cw_amode(11) - loffset
